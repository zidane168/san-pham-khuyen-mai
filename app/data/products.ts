export const productsData = {    
    ...
    "data": [
        ...
        }, 
        {
            ...
            "affiliateLink": "https://shorten.asia/QcNdYDs6",
            "voucherLink": "",
            "title": 'Giá Đỡ Điện Thoại có Chân Đế Cố Định Lựa Chọn Nào Tốt Nhất Cho Phát Sóng Trực Tiếp Ngoài Trời - Tiện Ích Không Ngờ',
            "description": " ", 
            "enabled": true,
            "created": "2025-04-26T15:09:59.828Z"
        }, 
...
<p>#tienichcuocsong</p>\
 sức khỏe của bạn - Domestic Condoms China - Tiện Ích Không Ngờ",
      ...
      
        {
            "id": 7,
            "categoryId": 1,
            "videoLink": "https://youtube.com/embed/jhOFjGhxo4s",
            "affiliateLink": "https://shorten.asia/uvMmjGBg",
            "voucherLink": "",
            "title": "Keo Chống Thấm Vét nứt Tường - Wall Crack Sealant - Tiện Ích Không Ngờ",
            "description": "<p><em>Keo Chống Thấm Vét nứt Tường</em> không cần tốn tiền thợ xây bạc triệu - Waterproof Glue to Fill Wall Cracks Without Spending Millions on Construction Workers</p>\n<p>Trong quá trình sử dụng, tường nhà có thể gặp phải tình trạng nứt, thấm nước, điều này không chỉ ảnh hưởng đến mỹ quan mà còn gây giảm tuổi thọ cho ngôi nhà. Để khắc phục vấn đề này mà không cần phải tốn hàng triệu cho thợ xây, keo chống thấm vết nứt tường xuất hiện như một giải pháp lý tưởng và tiết kiệm. Hãy cùng tìm hiểu về sản phẩm này.</p>\n<p>Keo Chống Thấm Vết Nứt Tường Là Gì?\nKeo chống thấm vết nứt tường là loại keo đặc biệt được thiết kế để lấp đầy các vết nứt trên tường, ngăn chặn nước thấm vào bên trong và bảo vệ cấu trúc của ngôi nhà. Sản phẩm thường được làm từ cao su, silicone, hoặc polyurethane, có khả năng bám dính mạnh và linh hoạt khi khô.</p>\n<p>Tính Năng Nổi Bật Của Keo Chống Thấm Vết Nứt Tường\nChống Thấm Nước Xuất Sắc: Keo chống thấm có khả năng ngăn chặn nước thấm vào từ các vết nứt, bảo vệ tường khỏi ẩm mốc và hư hại.\nLấp Đầy Vết Nứt Hiệu Quả: Sản phẩm có khả năng lấp đầy các vết nứt với kích thước khác nhau, tạo bề mặt nhẵn mịn và không bị nhìn thấy.\nDễ Dàng Sử Dụng: Keo chống thấm thường được thiết kế với ống bơm hoặc đầu phun giúp người dùng dễ dàng áp dụng mà không cần dụng cụ phức tạp.\nĐộ Bền Cao: Sau khi khô, keo tạo ra một lớp vỏ bảo vệ chắc chắn, có khả năng chống lại sự tác động của môi trường như nắng, mưa và nhiệt độ.\nLợi Ích Khi Sử Dụng Keo Chống Thấm Vết Nứt Tường\nTiết Kiệm Chi Phí: Thay vì phải tốn hàng triệu đồng để thuê thợ xây sửa chữa, bạn có thể tự tay khắc phục các vết nứt chỉ với một ít keo chống thấm.\nDễ Dàng Thực Hiện Tại Nhà: Việc sử dụng keo chống thấm rất đơn giản, bạn không cần phải có kỹ năng xây dựng chuyên nghiệp vẫn có thể làm được.\nGiải Quyết Nhanh Chóng Vấn Đề: Với khả năng khô nhanh, bạn có thể khắc phục ngay các vết nứt mà không cần phải chờ đợi lâu.\nBảo Vệ Được Cấu Trúc Tường: Sử dụng keo chống thấm giúp bảo vệ tường nhà khỏi sự tác động của nước, từ đó kéo dài tuổi thọ cho ngôi nhà của bạn.\nCách Sử Dụng Keo Chống Thấm Vết Nứt Tường\nChuẩn Bị Bề Mặt: Trước khi áp dụng, hãy làm sạch vết nứt và khu vực xung quanh để đảm bảo keo bám dính tốt.\nÁp Dụng Keo: Sử dụng ống bơm hoặc đầu phun để bơm keo vào vết nứt. Đảm bảo rằng keo đã lấp đầy hoàn toàn vết nứt.\nChờ Khô: Sau khi áp dụng, hãy đợi keo khô hoàn toàn theo hướng dẫn của nhà sản xuất.\nKiểm Tra: Kiểm tra lại bề mặt tường sau khi keo đã khô để đảm bảo rằng không còn vết nứt nào và nước không còn thấm vào.</p>\n<p>#tienichcuocsong \n#tienichgiadinh \n#tienichkhongngo\n#tienichxaynha\n#keochongtham</p>\n",
            "enabled": true,
            "created": "2025-04-06T16:09:59.828Z"
        },
        {
            "id": 6,
            "categoryId": 1,
            "videoLink": "https://youtube.com/embed/aTaYOASR5-E",
            "affiliateLink": "https://shorten.asia/dH9qqfZr",
            "voucherLink": "",
            "title": "Thanh Treo Quần Áo Không Cần Khoan Tường - Tiện Ích Không Ngờ",
            "description": "<p><em>Thanh Treo Quần Áo Không Cần Khoan Tường - Tiện Ích Không Ngờ</em> </p>\n<p>Trong không gian sống hiện đại, đặc biệt là ở những căn hộ nhỏ hoặc nhà cho thuê, việc tối ưu hóa diện tích sử dụng là một nhiệm vụ quan trọng. Một trong những giải pháp thông minh nhằm giải quyết vấn đề này chính là thanh treo quần áo không cần khoan tường. Với thiết kế tiện dụng và linh hoạt, sản phẩm này đã trở thành một trợ thủ đắc lực giúp tổ chức, sắp xếp quần áo một cách hiệu quả mà không làm hư hại tường hay tốn quá nhiều không gian.</p>\n<p>Thanh Treo Quần Áo Không Cần Khoan Tường Là Gì?\nThanh treo quần áo không cần khoan tường là một loại thiết bị treo quần áo được thiết kế đặc biệt, cho phép người dùng dễ dàng lắp đặt mà không cần phải khoan lỗ lên tường. Thay vào đó, sản phẩm này thường sử dụng các phương pháp gắn kết khác như keo dán mạnh mẽ, gắn trên bề mặt cửa, hoặc các cách gắn tạm thời khác, giúp bảo vệ bức tường và dễ dàng tháo gỡ khi cần.</p>\n<p>Tính Năng Nổi Bật Của Thanh Treo Quần Áo Không Cần Khoan Tường\nDễ Dàng Lắp Đặt: Một trong những ưu điểm lớn nhất của sản phẩm này chính là sự dễ dàng trong việc lắp đặt. Bạn không cần phải có kỹ năng hay dụng cụ đặc biệt, chỉ cần làm theo hướng dẫn đi kèm là có thể lắp đặt nhanh chóng.\nKhông Gây Hư Hại: Nhờ vào thiết kế không cần khoan tường, thanh treo quần áo này giúp bảo vệ bức tường của bạn khỏi những lỗ khoan xấu xí và hư hỏng. Điều này đặc biệt quan trọng với những căn hộ cho thuê, nơi bạn không muốn gây thiệt hại cho tài sản.\nTiết Kiệm Không Gian: Thanh treo quần áo không cần khoan tường giúp tối ưu hóa diện tích sử dụng, cho phép bạn treo quần áo mà không tốn quá nhiều diện tích. Bạn có thể sử dụng trong phòng ngủ, phòng tắm, hoặc ngay cả ở khu vực hành lang mà không lo lắng về việc chiếm dụng không gian.\nTính Linh Hoạt: Điều đặc biệt về sản phẩm này là bạn có thể dễ dàng di chuyển nó đến vị trí khác nếu cần. Nếu bạn chuyển đến một chỗ ở mới, chỉ cần tháo ra và gắn lại mà không để lại dấu vết.\nLợi Ích Khi Sử Dụng Thanh Treo Quần Áo Không Cần Khoan Tường\nTiện Lợi và Thực Tế: Thanh treo này rất thích hợp cho những ai có lối sống bận rộn và cần một giải pháp nhanh chóng và tiện lợi để tổ chức quần áo của mình. Bạn có thể nhanh chóng treo quần áo khi trở về nhà mà không cần lo lắng về không gian lưu trữ.\nTạo Ra Không Gian Ngăn Nắp: Sử dụng thanh treo quần áo giúp bạn tạo ra không gian gọn gàng hơn. Chỉ cần treo quần áo lên thanh, bạn sẽ không còn phải tìm kiếm chúng trong đống đồ lộn xộn.\nTiết Kiệm Chi Phí: Với khả năng sử dụng linh hoạt và đơn giản, thanh treo quần áo không cần khoan tường là một giải pháp tiết kiệm chi phí tốt hơn so với việc lắp đặt các hệ thống treo quần áo truyền thống, thường đòi hỏi nhiều công sức và tiền bạc.\nPhong Cách và Tùy Chỉnh: Hiện nay, nhiều mẫu thanh treo quần áo không cần khoan tường có thiết kế hiện đại và phong cách. Bạn có thể chọn cho mình một sản phẩm phù hợp với nội thất của căn nhà, làm tăng tính thẩm mỹ cho không gian sống.\nCách Sử Dụng Thanh Treo Quần Áo Không Cần Khoan Tường\nChuẩn Bị Bề Mặt: Trước khi lắp đặt thanh treo, hãy đảm bảo bề mặt mà bạn định gắn vào là sạch sẽ và khô ráo. Điều này giúp tăng cường độ bám dính của keo.\nLắp Đặt Thanh Treo: Theo hướng dẫn lắp đặt, bạn chỉ cần vệ sinh bề mặt và dán keo hoặc công cụ gắn kèm rồi</p>\n<p>#thanhtreoquanaokhongcankhoantuong\n#tienichkhongngo\n#tienichgiadinh \n#tienichcuocsong</p>\n",
            "enabled": true,
            "created": "2025-04-06T16:09:31.688Z"
        },
        {
            "id": 5,
            "categoryId": 1,
            ...
            "description": "<p><em>Thùng Rác Thông Minh - Smart Trash Can - Tiện Ích Không Ngờ</em></p>\n \n<p>Trong thế giới ngày nay, khi cuộc sống ngày càng trở nên nhanh chóng và hiện đại, những thiết bị gia dụng thông minh đã trở thành một phần không thể thiếu trong mỗi gia đình. Một trong những sản phẩm đang được nhiều người tiêu dùng ưa chuộng chính là thùng rác thông minh. Vậy thùng rác thông minh là gì? Nó có những tính năng nổi bật nào và mang lại tiện ích ra sao? Hãy cùng khám phá trong bài viết này.</p>\n<p>Thùng Rác Thông Minh Là Gì?\nThùng rác thông minh, hay còn gọi là smart trash can, là một loại thùng rác được thiết kế đặc biệt với những công nghệ tiên tiến. Thay vì chỉ đơn thuần là nơi chứa rác, thùng rác thông minh còn tích hợp nhiều tính năng hữu ích như tự động mở nắp, cảm biến giúp nhận diện khi có người đến gần, hoặc thậm chí có khả năng phân loại rác. Nhờ vậy, sản phẩm này không chỉ giúp tiết kiệm không gian mà còn tạo ra sự tiện lợi cho người sử dụng.</p>\n<p>Tính Năng Nổi Bật Của Thùng Rác Thông Minh\nCảm Biến tự động: Một trong những tính năng nổi bật nhất của thùng rác thông minh là khả năng tự động mở nắp thông qua cảm biến. Khi bạn lại gần thùng rác, nắp sẽ tự động mở ra mà không cần phải chạm tay vào. Điều này giúp bạn dễ dàng loại bỏ rác mà không lo ngại về việc lây nhiễm vi khuẩn hay bẩn tay.\nPhân Loại Rác: Nhiều mẫu thùng rác thông minh hiện nay được trang bị khả năng phân loại rác thông minh. Với những thùng rác này, bạn chỉ cần cho rác vào thùng và hệ thống sẽ tự động phân loại theo loại chất thải (như rác hữu cơ, rác tái chế, rác không tái chế…). Điều này không chỉ giúp bảo vệ môi trường mà còn giúp bạn làm giảm tối đa lượng rác thải mà bạn tạo ra.\nChức Năng Khử Mùi: Những thùng rác thông minh còn được trang bị bộ lọc khử mùi hiện đại, giúp ngăn chặn mùi hôi khó chịu từ rác thải. Nhờ đó, không gian sống của bạn sẽ luôn sạch sẽ và dễ chịu hơn.\nThiết Kế Thân Thiện: Các thùng rác thông minh thường có thiết kế hiện đại và tinh tế, phù hợp với nhiều kiểu không gian sống khác nhau từ căn hộ nhỏ đến ngôi nhà rộng lớn. Với nhiều màu sắc và kích cỡ khác nhau, bạn có thể dễ dàng chọn cho mình một chiếc thùng rác phù hợp nhất.\nLợi Ích Khi Sử Dụng Thùng Rác Thông Minh\nTiết Kiệm Thời Gian: Với tính năng tự động mở nắp và khả năng phân loại rác, việc bảo quản và xử lý rác thải trở nên đơn giản hơn bao giờ hết. Bạn sẽ không cần mất nhiều thời gian cho việc sắp xếp và dọn dẹp rác trong nhà.\nGiữ Vệ Sinh: Thùng rác thông minh giúp bạn hạn chế việc tiếp xúc trực tiếp với rác, giảm nguy cơ lây nhiễm bệnh tật. Điều này đặc biệt quan trọng trong thời điểm dịch bệnh đang hoành hành như hiện nay.\nThân Thiện với Môi Trường: Nhờ vào tính năng phân loại rác thông minh, bạn có thể góp phần bảo vệ môi trường bằng cách giảm thiểu lượng rác không tái chế và tối ưu hóa quy trình tái chế. Việc này không chỉ có lợi cho trái đất mà còn nâng cao ý thức bảo vệ môi trường của người dùng.\nDễ Dàng Sử Dụng và Bảo Quản: Hầu hết các thùng rác thông minh đều được thiết kế với giao diện dễ sử dụng và hướng dẫn cụ thể. Bạn không cần quá nhiều thời gian hay công sức để làm quen với sản phẩm.</p>\n<p><em>Cách Sử Dụng Thùng Rác Thông Minh</em>\nSử dụng thùng rác thông minh rất đơn giản:</p>\n<p>Bỏ Rác: Chỉ cần đến gần thùng rác và nắp sẽ tự động mở ra. Sau khi bỏ rác xong, nắp sẽ tự động đóng lại.\nVệ Sinh Thùng: Để duy trì hiệu suất hoạt động của thùng rác, bạn nên thường xuyên vệ sinh bên</p>\n<p>#thungracthongminh \n#tienichkhongngo\n#tienichgiadinh \n#tienichcuocsong</p>\n",
            "enabled": true,
            "created": "2025-04-06T16:09:06.958Z"
        },
        {
            "id": 4,
            "categoryId": 1,
            "videoLink": "https://youtube.com/embed/rpDxgVLobSk",
            "affiliateLink": "https://shorten.asia/Tx733dsV",
            "voucherLink": "",
            "title": "Miếng Lót Chống Rung Máy Giặt - Washing machine anti vibration pad  - Tiện Ích Không Ngờ",
            "description": "<p><em>Miếng Lót Chống Rung Máy Giặt - Washing machine anti vibration pad  - Tiện Ích Không Ngờ</em></p>\n<p>Trong cuộc sống hiện đại, máy giặt đã trở thành một thiết bị gia dụng không thể thiếu trong mỗi gia đình. Tuy nhiên, nhiều người không nhận ra rằng máy giặt còn có thể gây ra tiếng ồn và rung lắc mạnh mẽ trong quá trình hoạt động, đặc biệt là khi máy chạy ở chế độ vắt. Đây là lúc miếng lót chống rung máy giặt trở thành một giải pháp vô cùng hữu ích. Vậy miếng lót chống rung máy giặt là gì và nó mang lại những tiện ích gì? Hãy cùng khám phá trong bài viết này.</p>\n<p>Miếng Lót Chống Rung Máy Giặt Là Gì?\nMiếng lót chống rung máy giặt là một sản phẩm được thiết kế đặc biệt để giảm thiểu sự rung lắc và tiếng ồn phát ra từ máy giặt trong quá trình hoạt động. Thường được làm từ vật liệu cao su hoặc silicone, các miếng lót này được đặt dưới chân của máy giặt, giúp duy trì độ ổn định và tạo ra một bề mặt chống trượt hiệu quả.</p>\n<p>Tính Năng Nổi Bật Của Miếng Lót Chống Rung Máy Giặt\nGiảm Độ Rung Lắc: Tính năng nổi bật nhất của miếng lót chống rung là khả năng hấp thụ và giảm thiểu các cơn rung lắc không mong muốn từ máy giặt. Điều này giúp bảo vệ thiết bị và kéo dài tuổi thọ cho máy.\nGiảm Tiếng Ồn: Miếng lót cũng có tác dụng giảm tiếng ồn khi máy giặt hoạt động. Bằng cách hấp thụ các tác động từ chân máy giặt, nó giúp mang lại một không gian sống yên tĩnh hơn.\nDễ Dàng Lắp Đặt: Miếng lót chống rung rất dễ dàng lắp đặt. Bạn chỉ cần đặt chúng dưới chân máy giặt mà không cần đến bất kỳ công cụ hay kỹ năng chuyên môn nào.\nChất Liệu Bền Bỉ: Thường được làm từ cao su hoặc silicone, các miếng lót chống rung có độ bền cao và khả năng chịu được nhiệt độ cũng như độ ẩm, đảm bảo sản phẩm có thể sử dụng lâu dài.\nLợi Ích Khi Sử Dụng Miếng Lót Chống Rung Máy Giặt\nBảo Vệ Sàn Nhà: Miếng lót chống rung giúp bảo vệ sàn nhà khỏi những hư hại do sự rung lắc của máy giặt gây ra. Không chỉ giúp tránh trầy xước, nó còn giữ cho sàn nhà luôn sạch sẽ và đẹp đẽ hơn.\nTiết Kiệm Chi Phí Sửa Chữa: Việc giảm rung lắc không chỉ mang lại cảm giác dễ chịu mà còn giúp giảm thiểu chi phí sửa chữa cho máy giặt. Khi máy hoạt động ổn định, ít có nguy cơ hư hỏng và bảo trì thiết bị.\nSự Ổn Định Khi Hoạt Động: Miếng lót chống rung góp phần duy trì sự ổn định cho máy giặt, tránh được tình trạng máy bị lắc lư hay dịch chuyển trong quá trình hoạt động, từ đó giúp việc giặt giũ trở nên dễ dàng và hiệu quả hơn.\nTiết Kiệm Không Gian: Với kích thước nhỏ gọn, miếng lót chống rung không chiếm nhiều diện tích, giúp bạn tiết kiệm không gian trong phòng giặt hoặc khu vực đặt máy giặt.\nCách Sử Dụng Miếng Lót Chống Rung Máy Giặt\nChuẩn Bị Bề Mặt: Đảm bảo rằng bề mặt mà bạn sẽ đặt máy giặt là phẳng và sạch sẽ. Nếu cần, hãy vệ sinh bề mặt để có độ dính tốt nhất.\nĐặt Miếng Lót: Đặt miếng lót chống rung dưới chân máy giặt. Hãy chắc chắn rằng tất cả các chân của máy giặt đều nằm trên miếng lót để đạt hiệu quả tối ưu.\nKiểm Tra Ổn Định: Sau khi đặt miếng lót, hãy kiểm tra máy giặt trong quá trình hoạt động để đảm bảo rằng nó không còn rung lắc mạnh. Nếu cần, hãy điều chỉnh vị trí của miếng lót cho phù hợp.</p>\n<p>#mienglotchongrung\n#tienichkhongngo\n#tienichgiadinh \n#tienichcuocsong</p>\n",
            "enabled": true,
            "created": "2025-04-06T16:08:39.294Z"
        },
        {
            "id": 3,
            "categoryId": 1,
            ...
            "description": "<p><em>Giỏ Đựng Quần Áo Có Bánh Xe - Wear clothes with wheels - Tiện Ích Không Ngờ</em></p>\n<p>Trong một thế giới ngày càng bận rộn và tiện nghi, việc giữ gìn đồ đạc ngăn nắp và dễ dàng di chuyển là rất quan trọng. Một giải pháp ngày càng được ưa chuộng là giỏ đựng quần áo có bánh xe. Đây là một sản phẩm thông minh kết hợp giữa tính năng chứa đựng và khả năng di chuyển thuận tiện. Bài viết này sẽ khám phá những lợi ích và tiện ích không ngờ mà giỏ đựng quần áo có bánh xe mang lại.</p>\n<p>Giỏ Đựng Quần Áo Có Bánh Xe Là Gì?\nGiỏ đựng quần áo có bánh xe là loại giỏ được thiết kế với khả năng chứa quần áo bẩn hoặc đồ dùng cá nhân, và được trang bị bánh xe để dễ dàng di chuyển. Thường được làm từ chất liệu nhựa, vải hoặc kim loại nhẹ, giỏ này không chỉ giúp tổ chức quần áo mà còn mang lại sự tiện lợi cho người dùng khi cần di chuyển chúng từ chỗ này sang chỗ khác.</p>\n<p>Tính Năng Nổi Bật Của Giỏ Đựng Quần Áo Có Bánh Xe\nDễ Dàng Di Chuyển: Với bánh xe linh hoạt, người dùng có thể dễ dàng kéo hoặc đẩy giỏ đến bất kỳ đâu mà không tốn nhiều sức lực. Điều này đặc biệt hữu ích trong những không gian nhỏ hay khi bạn cần chuyển đồ từ phòng ngủ sang phòng giặt.\nThiết Kế Thông Minh: Nhiều giỏ đựng quần áo có bánh xe được thiết kế thông minh với nhiều ngăn, giúp tổ chức đồ đạc một cách hợp lý. Bạn có thể tách biệt quần áo bẩn, quần áo sạch và các đồ dùng khác, giúp tiết kiệm thời gian khi giặt giũ hay sắp xếp.\nChất Liệu Bền Bỉ: Thông thường, giỏ này được làm từ các chất liệu cao cấp, bền bỉ với khả năng chịu lực tốt. Điều này đảm bảo sản phẩm có thể sử dụng lâu dài mà không bị hư hỏng.\nTính Năng Gập Gọn: Nhiều model giỏ có bánh xe có thể gập gọn lại khi không sử dụng, giúp tiết kiệm không gian lưu trữ.\nLợi Ích Khi Sử Dụng Giỏ Đựng Quần Áo Có Bánh Xe\nTiết Kiệm Thời Gian: Việc di chuyển quần áo từ nơi này sang nơi khác trở nên nhanh chóng và dễ dàng hơn rất nhiều. Bạn sẽ không còn phải mang vác nặng nhọc, và do đó có thể tiết kiệm thời gian cho các công việc khác.\nGiữ Gìn Ngăn Nắp: Giỏ đựng quần áo giúp tổ chức mọi thứ một cách khoa học, giữ cho không gian sống gọn gàng và ngăn nắp. Điều này không chỉ mang lại cảm giác thoải mái mà còn góp phần nâng cao hiệu suất làm việc và sinh hoạt.\nTiện Lợi Khi Vận Chuyển: Nếu bạn thường xuyên phải di chuyển giữa nhà và ký túc xá, hoặc từ nhà đến phòng giặt chung, giỏ có bánh xe sẽ là một giải pháp lý tưởng. Bạn chỉ cần kéo theo mà không cần phải gồng mình bế vác.\nĐa Dạng Công Dụng: Ngoài việc đựng quần áo, giỏ có bánh xe còn có thể được sử dụng cho nhiều mục đích khác nhau, như chứa đồ chơi, đồ dùng học tập hay các vật dụng cá nhân, mang lại tính linh hoạt cho người dùng.\nCách Sử Dụng Giỏ Đựng Quần Áo Có Bánh Xe\nChọn Vị Trí Thích Hợp: Đặt giỏ ở vị trí thuận tiện trong phòng ngủ hoặc khu vực giặt ủi để dễ dàng sử dụng.\nPhân Loại Đồ Đạc: Sắp xếp quần áo bẩn vào giỏ theo từng loại hoặc theo dự định giặt. Bạn cũng có thể dùng để chứa những đồ dùng khác như ga trải giường, khăn tắm, v.v.\nThường Xuyên Vệ Sinh: Để giỏ luôn trong tình trạng tốt, hãy vệ sinh thường xuyên, đặc biệt là khi bạn sử dụng chúng để chứa quần áo bẩn.</p>\n<p>#giodungquanaocobanhxe\n#wearclotheswithwheels\n#tienichkhongngo\n#tienichgiadinh \n#tienichcuocsong</p>\n",
            "enabled": true,
            "created": "2025-04-06T16:08:08.114Z"
        },
        {
            "id": 2,
            "categoryId": 1,
            ...
            "enabled": true,
            "created": "2025-04-06T16:07:27.616Z"
        },
        {
            "id": 1,
            "categoryId": 1,
            ...
            "enabled": true,
            "created": "2025-04-06T16:05:51.128Z"
        }
    ]
};